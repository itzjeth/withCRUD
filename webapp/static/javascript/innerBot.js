...
document.addEventListener("DOMContentLoaded", function () {
 ...
 const inputField = document.querySelector(".typing-textarea textarea");
 const chatOutput = document.getElementById("chatbott");
 const historyContainer = document.querySelector(".history");
 const newChatButton = document.querySelector(".layout button");
 ...
 function clearChat() {
   ...
   historyContainer.innerHTML = ""; // Clear the chat output
 ...
 function getCommonReply(message) {
   ...
   const chatScenarios = {
     "hi": "Hi, I'm a ChaitanyaGPT , Made by Sajeed and Srinivas",
      "who are you":"I'm Sting chat bot, i'm here to make chat with you ,tell me what can i assist you? ", 
 ...
 "what is the capital city of india":"Dehli is the capatal city of india",
     "hello": "Hi there! i am Sting but,tell me what can i assist you?",
